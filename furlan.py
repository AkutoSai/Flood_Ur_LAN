...
try:
	...
	while a > 0:
	    mac = "aa:11:" + ":".join(("%02x" % rand.randint(0, 255) for i in range(4)))
	    ipv6 = "fe80::218:" + ":".join(("%x" % rand.randint(0, 16**4) for i in range(3)))
	    prefix1 = "2a01:" + ":".join(("%x" % rand.randint(0, 16**4) for i in range(3))) + "::"
